...
def test_dlite2cuds_create_cuds(repo_dir):
    ...
    Here all instances are first created. Because some of
    the instances in the relations are missing at the end
    the first instances is created again to add the final
    relations.
    """
    import dlite
    import pytest
